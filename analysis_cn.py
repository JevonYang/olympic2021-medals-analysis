...
if __name__ == '__main__':
    ...
    print(medal_list.groupby(['country', 'athlete_name']).count().sort_values(
        'event_name', ascending=False).head(20))

    print(medal_list[medal_list['medal_type'] == '金牌'].groupby(['country', 'athlete_name']).count().sort_values('event_name', ascending=False).head(20))
